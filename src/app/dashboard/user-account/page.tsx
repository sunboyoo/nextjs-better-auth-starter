...
import { UserPhoneCard } from "./_components/user-phone-card";
...
export default async function UserAccountPage() {
  ...
  return (
    <div className="w-full space-y-8">
      ...
      <AuthResilienceCard
        hasVerifiedEmailChannel={hasVerifiedEmailChannel}
        hasVerifiedPhoneChannel={hasVerifiedPhoneChannel}
        hasPasskey={hasPasskey}
        hasPassword={hasPassword}
        primaryAuthChannel={userPrimaryAuthChannel}
      />
      ...
      <section className="space-y-3">
        ...
        <div className="space-y-4">
          ...
          <UserEmailCard
            ...
            emailDeliverable={userEmailDeliverable}
            primaryAuthChannel={userPrimaryAuthChannel}
          />
          <UserPhoneCard
