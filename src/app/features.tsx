...
export function Features() {
  return (
    <div className="mx-auto flex w-full flex-col gap-4 bg-white px-8 dark:bg-black lg:flex-row">
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        ...
        <h2 className="relative z-10 mt-4 text-xl font-bold text-black opacity-0 transition duration-200 group-hover/canvas-card:-translate-y-2 group-hover/canvas-card:opacity-100 group-hover/canvas-card:text-white dark:text-white">
          {title}
        </h2>
      </div>
    </div>
